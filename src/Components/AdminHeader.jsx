...
const Header = () => {
  ...
  return (
    <header className="bg-black text-white shadow-lg sticky top-0 z-10 py-4 px-4">
      <div className="container mx-auto flex items-center justify-between ">
              ...
              <ul className="flex">
                <li className={`md:hidden relative ${!isSmallScreen && 'w-0'}`}>
                  <select
                    ...
                    className="block appearance-none bg-transparent border border-white text-white py-2 px-2 pr-2 rounded leading-tight focus:outline-none focus:border-white focus:bg-transparent"
                  >
                    <option value={`/admin/AddProduct`}>Add Product</option>
                    <option value={`/admin/updateProduct`}>Update poroduct</option>
                  </select>
                  ...
                  {isSmallScreen && <li className={`${isSmallScreen ?  'flex    text-xl md:gap-3': 'flex'}`}>
                      <NavLink
                      to={`/admin/AddProduct`}
                      className={({ isActive }) =>
                    ...
                    >
                      <h3 className="hidden md:block">AddProduct</h3>
                    </NavLink>
                    ...
                    >
                      <h3 className="hidden md:block">UpdateProduct</h3>
                    </NavLink>                    
                    </li>
        ...
        <div className="flex">
        <button 
            className="px-2 py-2 md:px-6 md:py-3 bg-white text-black font-semibold hover:bg-black hover:text-white border border-black transition duration-100 ease-in-out hover:border-white rounded-md focus:outline-none "
            onClick={() => handleClick()}
          >
            Logout
          </button>
...
//   useEffect(() => {
//     const checkScreenSize = () => {
//       setIsSmallScreen(window.innerWidth < 640); // Adjust the threshold according to your needs
//     };
...
//                   }
//                 >
//                   <h3 className="hidden md:block">Update Product</h3>
//                 </NavLink>
//               </li>
//             ) : (
//               <>
//                 <li className={`relative ${!isSmallScreen && 'w-0'}`}>
//                   <select
//                     onChange={(e) => {
//                       const url = e.target.value;
//                       navigate(url);
...
//                   >
//                     <option value={`/admin/AddProduct`}>Add Product</option>
//                     <option value={`/admin/updateProduct`}>Update Product</option>
//                   </select>
//                   <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-white">
//                     <svg
//                       className="fill-current h-4 w-4"
